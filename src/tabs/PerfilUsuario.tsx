...
export default function PerfilUsuario({ navigation }) {
    ...
    return (
        <VStack flex={1} alignItems="center" p={5} justifyContent="center">
            ...
            <Button w="100%" bg={TEMAS.colors.blue[800]} mt={10} borderRadius="lg" onPress={() => navigation.navigate('AtualizaUsuario')}>
                Editar Usuário
            </Button>

            <Button w="100%" bg={TEMAS.colors.red[500]} mt={5} borderRadius="lg" onPress={() => navigation.replace('Login')}>
                Logoff
            </Button>
        </VStack>
    );
