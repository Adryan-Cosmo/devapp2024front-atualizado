...
export default function ManejoPrincipal({navigation}) {
  ...
  return (
    <VStack flex={1} space={4} alignItems="center" p={5} justifyContent="center">
        ...
        <Button  w="95%" size={'lg'} leftIcon={<Icon as={MaterialCommunityIcons} name="clipboard-text-clock" size="lg"/>}
        onPress={() => navigation.navigate('CadastroManejo')}>
            Dados de Manejo - cadastro?
        </Button>
        ...
        <Center>
            ...
            <Modal.Content maxWidth="350" maxH="400">
                ...
                <Modal.Body>
                <Text>Gerencie as informações de manejo.</Text>
