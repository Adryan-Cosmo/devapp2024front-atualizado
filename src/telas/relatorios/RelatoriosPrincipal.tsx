...
export default function RelatoriosPrincipal({navigation}) {
    ...
    <VStack flex={1} space={4} alignItems="center" p={5} justifyContent="center">
        ...
        <Center>
            ...
            <Modal.Content maxWidth="350" maxH="400">
                ...
                <Modal.Body>
                <Text>Liste informações cadastradas no aplicativo e gerencie os lançamentos realizados.</Text>
